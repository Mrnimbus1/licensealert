...
const LoginPage = () => {
  ...
  return (
    <AuthLayout 
      title={t('auth.login')} 
      subtitle={t('earlyAccess.loginSubtext')}
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full h-12 text-gray-700 border-2 border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 hover:shadow-md transition-all duration-200"
        ...
        <div className="text-right">
          <Link 
            ...
            className="text-sm text-indigo-600 hover:text-indigo-700 hover:underline font-medium transition-all duration-200"
          >
